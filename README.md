...
## 🚀 النشر على الإنترنت (رابط مباشر دائم)

لنشر التطبيق على الإنترنت والحصول على رابط مباشر دائم، استخدم **Streamlit Community Cloud** (مجاني):
...
4. **احصل على الرابط الدائم**
   - بعد انتهاء النشر، ستحصل على رابط مثل:
     ...
     ```
   - هذا الرابط يشتغل 24/7 مجاناً

### ملاحظات هامة للنشر:

| العنصر | الحالة |
|--------|--------|
| ملفات البيانات (`chroma_db/`, `data/*.json`) | مرفوعة على GitHub وجاهزة |
| قاعدة المعرفة | مبنية مسبقاً (1224 chunk) |
